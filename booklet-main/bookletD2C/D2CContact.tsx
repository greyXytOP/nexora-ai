  ...
  return (
    <Poster page="08 / 08" section="The Next Move" showWatermark={false}>
      ...
      <div className="flex h-full min-h-[260mm] flex-col">
        ...
        >
          Let&rsquo;s make your store feel
          <br />
          <span className="text-gradient">like it has a team behind it.</span>
        </motion.h2>
        ...
        >
          We don&rsquo;t start from a service list. We start from your actual bottleneck. One
          30-minute discovery call, no slides, no NDA. We&rsquo;ll map the two or three
          highest-leverage AI opportunities in your funnel and tell you straight whether
          it&rsquo;s worth shipping, what it&rsquo;ll cost, and how fast we can have it live on
          your store.
        </motion.p>
