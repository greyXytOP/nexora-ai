...
export function PosterContact() {
  return (
    <Poster page="14 / 14" section="Let's build" showWatermark={false}>
      <PosterDecor
        grid
        orbs={[
      ...
      <div className="flex h-full min-h-[260mm] flex-col">
        ...
        <motion.h2
          ...
          className="poster-title mt-7 text-[56px] leading-[1.0]"
        >
          Let&rsquo;s wire AI into the
          <br />
          <span className="text-gradient">workflows that move your numbers.</span>
        </motion.h2>
            ...
            <div className="flex flex-wrap items-center justify-between gap-4">
              ...
              <div className="flex flex-col items-end">
                <div className="font-display text-[24px] tracking-tight">
                  <span className="text-gradient-brand">shipping_at_velocity()</span>
                </div>
                <div className="mt-1 font-mono text-[10px] uppercase tracking-[0.22em] text-[var(--color-fg-subtle)]">
                  © {new Date().getFullYear()} Nuvero AI · v1.0 booklet
                </div>
              </div>
            </div>
          </div>
